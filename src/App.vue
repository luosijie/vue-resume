        ...
        <div class="resume">
            <div class="left">
                ...
                <ContextList title="CONTACT" :icon="require('@/assets/title-contact.png')">
                    <ListItemInfo title="1860***3412" :image="require('@/assets/contact-phone.png')" slot="listItem">
                    </ListItemInfo>
                    <ListItemInfo title="luo_sj@163.com" :image="require('@/assets/contact-mail.png')" slot="listItem">
                    </ListItemInfo>
                    <ListItemInfo title="lsj***inhao" :image="require('@/assets/social-wechat.png')" slot="listItem">
                    </ListItemInfo>
                    <ListItemInfo title="155***9564" :image="require('@/assets/social-qq.png')" slot="listItem">
                    </ListItemInfo>
                </ContextList>
                <ContextList title="SOCIAL" :icon="require('@/assets/title-contact.png')">
                    <ListItemInfo title="github.com/luosijie" :image="require('@/assets/social-github.png')" slot="listItem">
                    </ListItemInfo>
                    <ListItemInfo title="dribbble.com/luosj" :image="require('@/assets/social-dribbble.png')" slot="listItem">
                    </ListItemInfo>
                    <ListItemInfo title="behance.net/jesseluo" :image="require('@/assets/social-behance.png')" slot="listItem">
                    </ListItemInfo>
                    <ListItemInfo title="i.ui.cn/ucenter/122744" :image="require('@/assets/social-uicn.png')" slot="listItem">
                    </ListItemInfo>
                </ContextList>
            </div>
            <div class="right">
                ...
                <ContextList title="Education">
                    <ListItemEducation slot="listItem" school="Minjiang University" major="History" date="2011.9 — 2015.6"/>
                </ContextList>
